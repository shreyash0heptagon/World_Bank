    ...
    return (
      ...
      <div>
        ...
        <div className="toggle-menu-wrapper">
          ...
          <Button variant="contained" startIcon={<AddIcon/>} style={{maxWidth:"10rem",minWidth:"12rem", minHeight:"3rem", borderRadius:"0.3rem", backgroundColor:"#32cd32"}} size="large" onClick={this.setState({showResume:true})}>
          ADD Resume              
          </Button>
          </div>:""}
          </div>
