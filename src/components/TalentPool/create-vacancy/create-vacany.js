        ...
        <div className="toggle-menu-wrapper">
            <div className="form-wrapper">
                ...
                <div className="field-wrapper">
                    ...
                    <Button variant="contained" style={{backgroundColor:"#e5e4e2", color:"#000",maxWidth:"10rem",minWidth:"10rem",marginRight:"2rem"}} size="large">
                        cancel
                        </Button>
                        <Button variant="contained" style={{maxWidth:"10rem",minWidth:"10rem", backgroundColor:"#32cd32"}} size="large">
                        Save
                        </Button>
                    </div>
                </div>
